    ...
    public boolean onCommand(final CommandSender sender, final Command command, final String label, final String[] args) {
        ...
        try {
            ...
            if (args[0].equals("owner")) {
                ...
                gate.getSign().update();
                player.sendMessage("§eGate owner has been changed. To allow flexibility I do not check if this is a valid player. Keep this setting at own risk, or contact a moderator for help.");
                
            } else if (args[0].equals("type")) {
                
                gate.getSign().setLine(2, args[1]);
                gate.getSign().update();
                player.sendMessage("§eGate type has been changed. To allow flexibility I do not check if this is a valid gate type. Keep this setting at own risk, or contact a moderator for help.");
